# TorchRec (Beta Release) - with coverage measurement and additional tests

This repository was copied from the original TorchRec v0.2 repository. We then added coverage measuring capability and additional test cases to it. The added test cases are in the `eagle_plus_tests/` directory. Refer to [eagle_plus_tests/README.MD](eagle_plus_tests/README.MD) for instructions on how to run the tests and measure code coverage. Below are the original README from TorchRec v0.2. 
